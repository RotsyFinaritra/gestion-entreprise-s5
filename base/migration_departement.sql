...
('dept_informatique', 'password123', 'DEPARTEMENT', 'Département Informatique', 'Responsable du développement des systèmes d''information et des nouvelles technologies', 'informatique@entreprise.com'),
('dept_rh', 'password123', 'DEPARTEMENT', 'Département Ressources Humaines', 'Gestion du personnel, recrutement et développement des compétences', 'rh@entreprise.com'),
('dept_marketing', 'password123', 'DEPARTEMENT', 'Département Marketing', 'Stratégie marketing, communication et développement commercial', 'marketing@entreprise.com'),
('dept_finance', 'password123', 'DEPARTEMENT', 'Département Finance', 'Gestion financière, comptabilité et contrôle de gestion', 'finance@entreprise.com'),
('dept_operations', 'password123', 'DEPARTEMENT', 'Département Opérations', 'Gestion des opérations, logistique et production', 'operations@entreprise.com');
...
INSERT INTO users (username, password, role, nom_departement, description_departement, email_departement) VALUES
('admin_rh', 'admin123', 'RH', 'Service RH Central', 'Administration centrale des ressources humaines', 'admin.rh@entreprise.com');
